...
export const sheetContent: Record<number, SheetContent> = {
  101: {
    ...
    h1: 'Color the puppy — free printable coloring sheet',
    metaTitle: 'Puppy Coloring Page — Free Printable PDF',
    metaDescription:
  ...
  102: {
    slug: 'color-the-cat',
    h1: 'Color the cat — free printable coloring sheet',
    metaTitle: 'Cat Coloring Page — Free Printable PDF',
    metaDescription:
  ...
  103: {
    ...
    h1: 'Color the rabbit — free printable coloring sheet',
    metaTitle: 'Rabbit Coloring Page — Free Printable PDF',
    metaDescription:
  ...
  104: {
    slug: 'color-the-cow',
    h1: 'Color the cow — free printable coloring sheet',
    metaTitle: 'Cow Coloring Page — Free Printable PDF',
    metaDescription:
  ...
  105: {
    slug: 'color-the-bear',
    h1: 'Color the bear — free printable coloring sheet',
    metaTitle: 'Bear Coloring Page — Free Printable PDF',
    metaDescription:
  ...
  106: {
    ...
    h1: 'Color the monkey — free printable coloring sheet',
    metaTitle: 'Monkey Coloring Page — Free Printable PDF',
    metaDescription:
  ...
  107: {
    ...
    h1: 'Color the elephant — free printable coloring sheet',
    metaTitle: 'Elephant Coloring Page — Free Printable PDF',
    metaDescription:
  ...
  108: {
    slug: 'color-the-lion',
    h1: 'Color the lion — free printable coloring sheet',
    metaTitle: 'Lion Coloring Page — Free Printable PDF',
    metaDescription:
  ...
  109: {
    ...
    h1: 'Color the giraffe — free printable coloring sheet',
    metaTitle: 'Giraffe Coloring Page — Free Printable PDF',
    metaDescription:
  ...
  110: {
    ...
    h1: 'Color the kangaroo — free printable coloring sheet',
    metaTitle: 'Kangaroo Coloring Page — Free Printable PDF',
    metaDescription:
